...
from .models import Product,Customer,Cart,OrderedPlaced
	...
	if request.user.is_authenticated:
		...
		if cart_product:
			...
			return render(request,'app/addtocart.html',
				{'carts':carts,'total_amount':totalamount,'amount':amount})
		else:
...
def checkout(request):
	...
	return render(request, 'app/checkout.html',
		{'totalamount':totalamount,'add':add,'cart_item':cart_item})
